...
for stock in symbol_list_ibrx:
    # Retrieve data for the current stock
    stock_history = yf.Ticker(f"{stock}.SA").history(period="36mo")
    
    # Validates and receives dividends over a period of 2 years
    try:
    ...
    df_scan.loc[stock] = dividend_yield
